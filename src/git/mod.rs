...
pub use diff::{
    ...
    DiffPreviewData, DiffSearchIndex, DiffSearchLineKind, DiffSearchMatcher, DiffSearchOptions,
    DiffSearchResult, DiffSearchResults, DiffSearchSyntaxRange, DiffSelectionPane,
    DiffSelectionPoint, DiffStyle, DiffView, EstimatedDiffHeightOptions, EstimatedDiffHeights,
    ExpandedHunks, ExpandedRegion, FileContents, FileDiffMetadata, FileIterationOptions, FileLine,
    GapExpandDirection, Hunk, HunkContent, HunkData, HunkDataExpandable, HunkExpansionRegion,
    HunkLineType, HunkSeparatorKind, HunkSeparatorLayout, LineAnnotation, LineAnnotationName,
