...
pub use diff::{
    ChangeType, CodeColumnType, CodeOverflow, DiffDisplayLineAnchor, DiffHunkResolution,
    DiffIconType, DiffIndicators, DiffIterationOptions, DiffLine, DiffLineAnnotation,
    DiffLineMetadata, DiffLineType, DiffPreviewData, DiffSearchIndex, DiffSearchLineKind,
    DiffSearchMatcher, DiffSearchOptions, DiffSearchPreviewLine, DiffSearchResult,
    ...
    RenderRange, SelectedLineRange, SelectionSide, ThemeSpec, VirtualFileMetrics,
    VirtualWindowSpecs, WindowFromScrollPositionOptions, WorkerStats,
    ...
    build_merge_conflict_marker_rows, clean_last_newline, collect_diff_lines,
    compute_estimated_diff_heights, compute_virtual_file_metrics,
    ...
    load_diff_view_for_working_tree, parse_diff_from_file, parse_line_type,
