...
pub use diff::{
    ...
    DiffExactContext, DiffFileMetrics, DiffFingerprint, DiffHunkResolution, DiffIconType,
    DiffIndicators, DiffIterationOptions, DiffLine, DiffLineAnnotation, DiffLineMetadata,
    DiffLineTotals, DiffLineType, DiffPreviewData, DiffSearchIndex, DiffSearchLineKind,
    DiffSearchMatcher, DiffSearchMode, DiffSearchOptions, DiffSearchPreviewLine, DiffSearchResult,
    DiffSearchResults, DiffSearchSyntaxRange, DiffSelectionPane, DiffSelectionPoint, DiffStyle,
    DiffView, EstimatedDiffHeightOptions, EstimatedDiffHeights, ExpandedHunks, ExpandedRegion,
    FileContents, FileDiffMetadata, FileIterationOptions, FileLine, GapExpandDirection, Hunk,
    HunkContent, HunkData, HunkDataExpandable, HunkExpansionRegion, HunkLineType,
    HunkSeparatorKind, HunkSeparatorLayout, LineAnnotation, LineAnnotationName, LineDiffType,
    LineEndingType, MergeConflictActionAnchor, MergeConflictActionSlotInput,
