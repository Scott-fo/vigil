...
pub use diff::{
    ChangeDirection, ChangeType, CodeColumnType, CodeOverflow, DiffDisplayLineAnchor,
    DiffExactContext, DiffFileMetrics, DiffHunkResolution, DiffIconType, DiffIndicators,
    DiffIterationOptions, DiffLine, DiffLineAnnotation, DiffLineMetadata, DiffLineTotals,
    DiffLineType, DiffPreviewData, DiffSearchIndex, DiffSearchLineKind, DiffSearchMatcher,
    DiffSearchMode, DiffSearchOptions, DiffSearchPreviewLine, DiffSearchResult, DiffSearchResults,
    DiffSearchSyntaxRange, DiffSelectionPane, DiffSelectionPoint, DiffStyle, DiffView,
    EstimatedDiffHeightOptions, EstimatedDiffHeights, ExpandedHunks, ExpandedRegion, FileContents,
    FileDiffMetadata, FileIterationOptions, FileLine, GapExpandDirection, Hunk, HunkContent,
    HunkData, HunkDataExpandable, HunkExpansionRegion, HunkLineType, HunkSeparatorKind,
    HunkSeparatorLayout, LineAnnotation, LineAnnotationName, LineDiffType, LineEndingType,
    MergeConflictActionAnchor, MergeConflictActionSlotInput, MergeConflictDiffAction,
    MergeConflictLineType, MergeConflictMarkerLines, MergeConflictMarkerRow,
    MergeConflictMarkerRowType, MergeConflictParseResult, MergeConflictRegion,
    MergeConflictResolution, ParseDiffOptions, ParseMergeConflictDiffFromFileResult, ParsedLine,
    ParsedPatch, PreNodeType, PrePropertiesConfig, ProcessFileConflictData, RenderDiffOptions,
    ...
    ThemeSpec, VirtualFileMetrics, VirtualWindowSpecs, WindowFromScrollPositionOptions,
    ...
    load_diff_preview_for_commit_compare, load_diff_preview_for_working_tree,
    load_diff_search_index_for_branch_compare, load_diff_search_index_for_commit_compare,
    load_diff_search_index_for_working_tree, load_diff_view, load_diff_view_for_branch_compare,
    ...
    load_review_diff_snapshot_for_working_tree, load_review_diff_stats_for_branch_compare,
    ...
    load_review_diff_text_index_for_working_tree_streaming, parse_diff_from_file, parse_line_type,
