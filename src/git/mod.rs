...
pub use diff::{
    ...
    load_review_diff_text_index_for_branch_compare, load_review_diff_text_index_for_commit_compare,
    load_review_diff_text_index_for_working_tree, parse_diff_from_file, parse_line_type,
